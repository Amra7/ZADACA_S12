...
/**
 * Class that test class Bus. Contains main methods and adds example of buses
 * into new LinkedList of Buses. This class converts Bus to xml document.
 * 
...
public class BusTest {
	...
	/**
	 * Main method creates severeal bus lines.
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			Bus.toXML(busStation, new FileOutputStream(
					"./XML/BusLinesStation.xml"));
